...
/**
 * Server component — no handlers, so it stays out of the JS bundle.
 *
 * Plain img rather than next/image: listing photos are external URLs supplied
 * per business, and next/image requires every host to be declared in
 * next.config.js up front. An undeclared host fails outright, which for
 * user-supplied addresses means a broken card rather than an unoptimised one.
 * Revisit if image hosting moves in-house.
 *
